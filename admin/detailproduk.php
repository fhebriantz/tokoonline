...
<div class="row">
    <?php foreach ($fotoproduk as $key => $value) : ?>
        ...
        <div class="col-md-3 text-center">
            ...
            <a href="index.php?halaman=hapusfotoproduk&idfoto=<?php echo $value["id_produk_foto"] ?>&idproduk=<?php echo $id_produk ?>&idproduk=<?php echo $id_produk ?>" class="btn btn-danger btn-sm">Hapus</a>
        </div>
    <?php endforeach ?>
</div>
